...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    name: "BSBA-FM 4A",
    courseCode: "BSBA-FM",
    course: "Bachelor of Science in Business Administration - Financial Management",
    year: "4th Year",
    semester: "1st Semester",
    totalStudents: 18,
    activeStudents: 17,
  ...
  },
  {
    ...
    name: "BSBA-OM 4A",
    courseCode: "BSBA-OM",
    course: "Bachelor of Science in Business Administration - Operations Management",
    year: "4th Year",
    semester: "1st Semester",
    totalStudents: 12,
    activeStudents: 11,
...
export const SECTION_PERFORMANCE_DATA: SectionPerformanceData[] = [
  ...
  { section: "BSBA-FM 4A", students: 18, completion: 83 },
  { section: "BSBA-OM 4A", students: 12, completion: 78 },
  { section: "BEED 4A", students: 20, completion: 92 },
]
...
export const getAverageAttendanceAcrossSections = (): number => {
  const totalAttendance = SECTIONS.reduce((total, section) => total + section.avgAttendance, 0)
  return Math.round(totalAttendance / SECTIONS.length)
}

export const getAverageCompletionAcrossSections = (): number => {
  const totalCompletion = SECTIONS.reduce((total, section) => total + section.completionRate, 0)
