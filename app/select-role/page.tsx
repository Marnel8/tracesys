              ...
              <Button
                ...
                className={`h-24 sm:h-32 flex-col gap-2 sm:gap-4 border-2 transition-all duration-300 hover:scale-105 ${
                  selectedRole === "student"
                    ...
                    : "border-gray-300 text-gray-700 hover:border-primary-400 hover:bg-primary-50/50 hover:text-primary-700"
                }`}
            ...
            <div className="text-center mt-6 sm:mt-8 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center">
                <Button
                  ...
                  className="flex items-center gap-2 border-gray-300 text-gray-700 hover:border-primary-400 hover:bg-primary-50/50 hover:text-primary-700"
                >
