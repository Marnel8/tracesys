  ...
  return (
    <SidebarProvider defaultOpen={true}>
      ...
      <SidebarInset className="transition-all duration-200 ease-in-out">
        <Suspense fallback={<div className="flex items-center justify-center h-16">Loading...</div>}>
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 bg-gray-50 min-h-0 overflow-auto">{children}</main>
      </SidebarInset>
    </SidebarProvider>
  )
}
