    ...
    <div className="space-y-6">
        ...
        {/* <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new department to your academic structure.
              </DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <InstructorStatsCard
          ...
          helperText="Open for coordination"
          trend={
            activeDepartments > 0
              ? { label: `${activeDepartments} active`, variant: "positive" }
              : undefined
          }
          isLoading={isLoading}
        />
        <InstructorStatsCard
          ...
          label="Total Courses"
          value={totalCourses}
          helperText="Managed inside departments"
          isLoading={isLoading}
        />
      </div>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem
                      onClick={() =>
                        router.push(
                          `/dashboard/instructor/departments/${department.id}`
                        )
                      }
                    >
                    ...
                    <DropdownMenuItem
                      onClick={() =>
                        router.push(
                          `/dashboard/instructor/departments/${department.id}/edit`
                        )
                      }
                    >
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {departmentToDelete?.courses &&
                departmentToDelete.courses.length > 0 && (
                  <span className="block mt-2 text-red-600 font-medium">
                    This department has {departmentToDelete.courses.length}{" "}
                    active courses and cannot be deleted.
                  </span>
                )}
            </DialogDescription>
          </DialogHeader>
