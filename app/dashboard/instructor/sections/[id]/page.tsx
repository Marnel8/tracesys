...
import { useSection, useDeleteSection, useToggleSectionStatus } from "@/hooks/section";
						...
						<CardContent className="space-y-4">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-2xl font-bold">{studentsData?.students?.length || 0}</p>
								</div>
							</div>
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-2xl font-bold">
										{studentsData?.students?.filter((s: any) => s.isActive).length || 0}
									</p>
								</div>
							</div>
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-2xl font-bold">
										{studentsData?.students?.length || 0} / {section.maxStudents}
									</p>
								</div>
							</div>
						</CardContent>
					...
					<Card>
						...
						<CardContent className="space-y-2">
							...
							<Button
								variant="outline"
								className="w-full justify-start"
								onClick={() => router.push(`/dashboard/instructor/attendance?sectionId=${section.id}`)}
							>
				...
				<DialogContent>
						...
						<DialogDescription>
							...
							{studentsData?.students && studentsData?.students.length > 0 && (
								<span className="block mt-2 text-red-600 font-medium">
									This section has {studentsData?.students.length} enrolled students and cannot be deleted.
								</span>
							)}
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
						...
						<Button
							...
							disabled={deleteSection.isPending || (studentsData?.students && studentsData?.students.length > 0)}
						>
