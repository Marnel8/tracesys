        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Button onClick={handleProfileUpdate} className="bg-primary-500 hover:bg-primary-600">
                Save Changes
              </Button>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-gray-600">Get notified of new attendance submissions</p>
                </div>
                <Switch
              ...
              <Button onClick={handleNotificationUpdate} className="bg-primary-500 hover:bg-primary-600">
                Save Preferences
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleSecurityUpdate} className="bg-primary-500 hover:bg-primary-600">
