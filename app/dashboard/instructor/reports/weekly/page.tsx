...
export default function WeeklyReportsPage() {
  ...
  const hasActiveFilters =
    searchTerm || selectedStatus !== "all" || selectedWeek !== "all";
    ...
    return {
      ...
      averageRating:
        ratedReports.length > 0
          ? ratedReports.reduce((acc, r) => acc + (r.rating || 0), 0) /
            ratedReports.length
          : 0,
    };
  }, [weeklyReports]);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Review and evaluate student weekly progress reports
        </p>
      </div>
                            ...
                            <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
                              <DialogHeader>
                                <DialogTitle className="flex items-center gap-2">
                                  ...
                                  {selectedReport?.title} - Week{" "}
                                  {selectedReport?.weekNumber || "N/A"}
                                </DialogTitle>
                                            ...
                                            <div className="bg-white">
                                              <iframe
                                                ...
                                                onError={(e) => {
                                                  ...
                                                  errorDiv.className =
                                                    "flex flex-col items-center justify-center h-96 bg-gray-50 text-gray-500";
                                                  errorDiv.innerHTML = `
                                                  ...
                                                  <Button 
                                                    ...
                                                    variant="outline" 
                                                    className="mt-2"
                                                    onclick="window.open('${getFullFileUrl(
                                                      selectedReport.fileUrl!
                                                    )}', '_blank')"
                                                  >
                            ...
                            >
                              ...
                              <DialogContent>
                                <DialogHeader>
                                  ...
                                  <DialogDescription>
                                    Provide feedback and rating for this weekly
                                    report.
                                  </DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">
                ...
                {Math.min(currentPage * 50, reportsData.pagination.totalItems)}{" "}
                of {reportsData.pagination.totalItems} reports
              </div>
              <div className="flex items-center gap-2">
                  ...
                  {reportsData.pagination.totalPages > 5 && (
                    <>
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          setCurrentPage(reportsData.pagination.totalPages)
                        }
                        className="w-8 h-8 p-0"
                      >
                ...
                <Button
                  ...
                  onClick={() =>
                    setCurrentPage((prev) =>
                      Math.min(reportsData.pagination.totalPages, prev + 1)
                    )
                  }
