...
import { Plus, MessageSquare, Edit, Trash2, Eye, Calendar, Users } from "lucide-react"
...
const announcements = [
  {
    ...
    content: "Don't forget to submit your weekly reports by Friday, 5:00 PM. Late submissions will not be accepted.",
    targetSections: ["4A", "4B"],
    targetCourses: ["BSIT", "BSCS"],
    priority: "High",
    status: "Published",
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            <DialogHeader>
              ...
              <DialogDescription>Create a new announcement to share with your students.</DialogDescription>
            </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="4A">Section 4A</SelectItem>
                      <SelectItem value="4B">Section 4B</SelectItem>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateAnnouncement} className="bg-primary-500 hover:bg-primary-600">
                Create Announcement
              </Button>
            </DialogFooter>
          </DialogContent>
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <CardDescription className="text-base mb-3">{announcement.content}</CardDescription>
                  <div className="flex items-center gap-4 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {announcement.targetSections.join(", ")} • {announcement.targetCourses.join(", ")}
                    </div>
                    <div className="flex items-center gap-1">
