...
import { Course } from "@/data/departments";
...
export default function AdminCoursesPage() {
  ...
  // Fetch data - admin sees ALL courses
  ...
  // Admin sees all courses (no filtering by instructor's department)
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Manage all academic courses across the system
          </p>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new course to the academic programs.
              </DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <InstructorStatsCard
          ...
          trend={
            activeCourses > 0
              ? { label: `${activeCourses} active`, variant: "positive" }
              : undefined
          }
          isLoading={isLoading}
        />
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {courseToDelete?.sections &&
                courseToDelete.sections.length > 0 && (
                  <span className="block mt-2 text-red-600 font-medium">
                    This course has {courseToDelete.sections.length} active
                    sections and cannot be deleted.
                  </span>
                )}
            </DialogDescription>
          </DialogHeader>
