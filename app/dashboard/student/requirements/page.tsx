...
export default function RequirementsPage() {
  ...
  return (
    <div className="px-4 md:px-8 lg:px-16">
      ...
      <Card className="mb-6 border border-primary-200 shadow-sm">
        <CardContent className="p-4">
                    ...
                    <div className="flex flex-row lg:flex-col gap-3 ">
                      ...
                      >
                        <Button
                          size="sm"
                          variant="outline"
                          className="w-full border border-primary-500 bg-primary-50 text-primary-700 transition-all duration-300 hover:border-primary-400 hover:bg-primary-50/50"
                        >
        ...
        {activeTab === "submissions" && requirements.length === 0 && (
          <Card className="border border-primary-200 shadow-sm">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-sm text-gray-600">
                You haven't submitted any requirements yet. Check the templates
                tab to get started.
              </p>
            </CardContent>
          </Card>
