...
const agencySchema = z.object({
  ...
  if (data.agencyId || data.supervisorId || data.startDate || data.endDate) {
        ...
        <div className="invitation-hero">
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-muted-foreground">
              Complete your profile to get started. You can optionally add your practicum agency later.
            </p>
          </div>
        </div>
                ...
                <div className="space-y-6">
                  ...
                  {selectedAgency && (
                    <div className="space-y-2">
                      ...
                      <Select
                        value={
                          agencyForm.watch("supervisorId") ?? undefined
                        }
                        onValueChange={(value) =>
